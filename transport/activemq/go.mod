module github.com/samsaralc/kratos-transport/transport/activemq
...
require (
	...
	github.com/samsaralc/kratos-transport/broker/stomp v1.2.21
...
replace github.com/samsaralc/kratos-transport/broker/stomp => ../../broker/stomp
