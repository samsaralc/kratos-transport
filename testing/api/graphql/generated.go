...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Hygrothermograph.humidity":
		if e.complexity.Hygrothermograph.Humidity == nil {
			break
		}
...
func (ec *executionContext) _Hygrothermograph_humidity(ctx context.Context, field graphql.CollectedField, obj *Hygrothermograph) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Hygrothermograph_humidity(ctx, field)
	if err != nil {
		return graphql.Null
	}
...
func (ec *executionContext) _Hygrothermograph_temperature(ctx context.Context, field graphql.CollectedField, obj *Hygrothermograph) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Hygrothermograph_temperature(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
var hygrothermographImplementors = []string{"Hygrothermograph"}

func (ec *executionContext) _Hygrothermograph(ctx context.Context, sel ast.SelectionSet, obj *Hygrothermograph) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, hygrothermographImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Hygrothermograph")
		case "humidity":
			out.Values[i] = ec._Hygrothermograph_humidity(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "temperature":
			out.Values[i] = ec._Hygrothermograph_temperature(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
